  ...
  async function syncNu() {
    ...
    try {
      ...
      setSyncResult({
        ...
        data: {
          error: isTimeout
            ? 'De sync duurt langer dan 28 seconden — Netlify functie timeout. Klik nogmaals voor de volgende batch (max 3 per call in quick mode), of wacht op de nachtelijke cron.'
            : err.message,
        },
      });
    } finally {
